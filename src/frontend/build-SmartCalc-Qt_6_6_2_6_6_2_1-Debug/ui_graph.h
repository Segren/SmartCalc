...
class Ui_Graph {
 public:
  ...
  void setupUi(QWidget *Graph) {
    if (Graph->objectName().isEmpty()) Graph->setObjectName("Graph");
    ...
    background_grey_x->setStyleSheet(QString::fromUtf8(
        "QLabel {\n"
        "	qproperty-alignment: 'AlignVCenter | AlignRight';\n"
        "    color: white; /* \320\246\320\262\320\265\321\202 "
        "\321\202\320\265\320\272\321\201\321\202\320\260 */\n"
    ...
    background_grey_y->setStyleSheet(QString::fromUtf8(
        "QLabel {\n"
        "	qproperty-alignment: 'AlignVCenter | AlignRight';\n"
        "    color: white; /* \320\246\320\262\320\265\321\202 "
        "\321\202\320\265\320\272\321\201\321\202\320\260 */\n"
    ...
    background_grey_y_2->setStyleSheet(QString::fromUtf8(
        "QLabel {\n"
        "	qproperty-alignment: 'AlignVCenter | AlignRight';\n"
        "    color: white; /* \320\246\320\262\320\265\321\202 "
        "\321\202\320\265\320\272\321\201\321\202\320\260 */\n"
  ...
  void retranslateUi(QWidget *Graph) {
    Graph->setWindowTitle(
        QCoreApplication::translate("Graph", "Graph", nullptr));
    background_grey->setText(QString());
    label_xmin->setText(
        QCoreApplication::translate("Graph", "\321\205.min:   -5000", nullptr));
    label_xmax->setText(
        QCoreApplication::translate("Graph", "\321\205.max:    5000", nullptr));
    label_ymin->setText(
        QCoreApplication::translate("Graph", "y.min:   -1*10^6", nullptr));
    label_ymax->setText(
        QCoreApplication::translate("Graph", "y.max:    1*10^6", nullptr));
    label_step->setText(
        QCoreApplication::translate("Graph", "step:   0.1", nullptr));
