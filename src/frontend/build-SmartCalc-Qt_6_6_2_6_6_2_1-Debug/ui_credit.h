...
class Ui_Credit {
 public:
  ...
  void setupUi(QWidget *Credit) {
    ...
    Credit->resize(420, 358);
    creditAmount = new QLineEdit(Credit);
    creditAmount->setObjectName("creditAmount");
    creditAmount->setGeometry(QRect(200, 7, 211, 31));
    creditAmount->setStyleSheet(QString::fromUtf8(
    ...
    creditAmountText->setGeometry(QRect(57, 14, 131, 16));
    creditAmountText->setStyleSheet(QString::fromUtf8(
    ...
    creditTermText->setGeometry(QRect(10, 58, 171, 16));
    creditTermText->setStyleSheet(QString::fromUtf8(
        "font-size: 20px; /* \320\240\320\260\320\267\320\274\320\265\321\200 "
        "\321\210\321\200\320\270\321\204\321\202\320\260 */"));
    interestRateText = new QLabel(Credit);
    interestRateText->setObjectName("interestRateText");
    interestRateText->setGeometry(QRect(22, 98, 161, 21));
    interestRateText->setStyleSheet(QString::fromUtf8(
        "font-size: 20px; /* \320\240\320\260\320\267\320\274\320\265\321\200 "
        "\321\210\321\200\320\270\321\204\321\202\320\260 */"));
    paymentTypeText = new QLabel(Credit);
    paymentTypeText->setObjectName("paymentTypeText");
    paymentTypeText->setGeometry(QRect(31, 139, 161, 21));
    paymentTypeText->setStyleSheet(QString::fromUtf8(
        "font-size: 20px; /* \320\240\320\260\320\267\320\274\320\265\321\200 "
        "\321\210\321\200\320\270\321\204\321\202\320\260 */"));
    creditTerm = new QLineEdit(Credit);
    creditTerm->setObjectName("creditTerm");
    creditTerm->setGeometry(QRect(200, 50, 71, 31));
    creditTerm->setStyleSheet(QString::fromUtf8(
        "    color: white; /* \320\246\320\262\320\265\321\202 "
        "\321\202\320\265\320\272\321\201\321\202\320\260 */\n"
        "    background-color: #6b6b6b; /* "
        "\320\244\320\276\320\275\320\276\320\262\321\213\320\271 "
    ...
    interestRate->setGeometry(QRect(200, 93, 181, 31));
    interestRate->setStyleSheet(QString::fromUtf8(
        "    color: white; /* \320\246\320\262\320\265\321\202 "
        "\321\202\320\265\320\272\321\201\321\202\320\260 */\n"
        "    background-color: #6b6b6b; /* "
        "\320\244\320\276\320\275\320\276\320\262\321\213\320\271 "
    ...
    percentText->setGeometry(QRect(390, 93, 16, 20));
    paymentType = new QComboBox(Credit);
    paymentType->setObjectName("paymentType");
    paymentType->setGeometry(QRect(200, 135, 141, 31));
    paymentType->setStyleSheet(QString::fromUtf8(
        "    color: white; /* \320\246\320\262\320\265\321\202 "
        "\321\202\320\265\320\272\321\201\321\202\320\260 */\n"
        "    background-color: #6b6b6b; /* "
        "\320\244\320\276\320\275\320\276\320\262\321\213\320\271 "
    ...
    line->setGeometry(QRect(10, 173, 401, 21));
    line->setFrameShape(QFrame::HLine);
    line->setFrameShadow(QFrame::Sunken);
    monthlyPaymentsText = new QLabel(Credit);
    monthlyPaymentsText->setObjectName("monthlyPaymentsText");
    monthlyPaymentsText->setGeometry(QRect(10, 208, 161, 31));
    monthlyPaymentsText->setStyleSheet(QString::fromUtf8(
        "font-size: 20px; /* \320\240\320\260\320\267\320\274\320\265\321\200 "
        "\321\210\321\200\320\270\321\204\321\202\320\260 */"));
    overpayText = new QLabel(Credit);
    overpayText->setObjectName("overpayText");
    overpayText->setGeometry(QRect(50, 275, 121, 31));
    overpayText->setStyleSheet(QString::fromUtf8(
        "font-size: 20px; /* \320\240\320\260\320\267\320\274\320\265\321\200 "
        "\321\210\321\200\320\270\321\204\321\202\320\260 */"));
    totalPaymentText = new QLabel(Credit);
    totalPaymentText->setObjectName("totalPaymentText");
    totalPaymentText->setGeometry(QRect(30, 310, 141, 31));
    totalPaymentText->setStyleSheet(QString::fromUtf8(
        "font-size: 20px; /* \320\240\320\260\320\267\320\274\320\265\321\200 "
        "\321\210\321\200\320\270\321\204\321\202\320\260 */"));
    pushButton_clear = new QPushButton(Credit);
    pushButton_clear->setObjectName("pushButton_clear");
    pushButton_clear->setGeometry(QRect(323, 207, 91, 61));
    QFont font;
    ...
    pushButton_calculate->setGeometry(QRect(323, 281, 91, 61));
    QFont font1;
    ...
    background_grey->setGeometry(QRect(5, 197, 312, 155));
    QFont font2;
    ...
    monthlyPayments_show->setGeometry(QRect(173, 207, 137, 31));
    QFont font3;
    font3.setFamilies({QString::fromUtf8("Osaka")});
    font3.setPointSize(15);
    monthlyPayments_show->setFont(font3);
    monthlyPayments_show->setStyleSheet(QString::fromUtf8(
        "QLabel {\n"
        "	qproperty-alignment: 'AlignVCenter | AlignRight';\n"
    ...
    overpay_show->setGeometry(QRect(173, 278, 137, 31));
    overpay_show->setFont(font3);
    overpay_show->setStyleSheet(QString::fromUtf8(
        "QLabel {\n"
        "	qproperty-alignment: 'AlignVCenter | AlignRight';\n"
        "    color: black; /* \320\246\320\262\320\265\321\202 "
        "\321\202\320\265\320\272\321\201\321\202\320\260 */\n"
    ...
    totalPayment_show->setGeometry(QRect(173, 313, 137, 31));
    totalPayment_show->setFont(font3);
    totalPayment_show->setStyleSheet(QString::fromUtf8(
        "QLabel {\n"
        "	qproperty-alignment: 'AlignVCenter | AlignRight';\n"
        "    color: black; /* \320\246\320\262\320\265\321\202 "
        "\321\202\320\265\320\272\321\201\321\202\320\260 */\n"
    ...
    monthlyPayment2->setGeometry(QRect(173, 243, 137, 31));
    monthlyPayment2->setFont(font3);
    monthlyPayment2->setStyleSheet(QString::fromUtf8(
        "QLabel {\n"
        "	qproperty-alignment: 'AlignVCenter | AlignRight';\n"
        "    color: black; /* \320\246\320\262\320\265\321\202 "
        "\321\202\320\265\320\272\321\201\321\202\320\260 */\n"
    ...
    label->setGeometry(QRect(158, 251, 21, 16));
  ...
  void retranslateUi(QWidget *Credit) {
    Credit->setWindowTitle(
        QCoreApplication::translate("Credit", "Credit Calc", nullptr));
    creditAmountText->setText(
        QCoreApplication::translate("Credit", "Credit amount:", nullptr));
    creditTermText->setText(
        QCoreApplication::translate("Credit", "Credit term (month):", nullptr));
    interestRateText->setText(QCoreApplication::translate(
        "Credit", "Yearly interest rate:", nullptr));
    paymentTypeText->setText(
        QCoreApplication::translate("Credit", "Type of payments", nullptr));
    percentText->setText(QCoreApplication::translate("Credit", "%", nullptr));
    monthlyPaymentsText->setText(
        QCoreApplication::translate("Credit", "Monthly payments:", nullptr));
    overpayText->setText(
        QCoreApplication::translate("Credit", "Overpay:", nullptr));
    totalPaymentText->setText(
        QCoreApplication::translate("Credit", "Total payment:", nullptr));
    pushButton_clear->setText(
        QCoreApplication::translate("Credit", "Clear", nullptr));
